      ...
      <div className="section mainsection">
        ...
        <VerticalTimeline lineColor={linecolor}>
          ...
          >
            ...
            <p data-aos="fade-right">
              Extensive experience in developing scalable server-side applications using Node.js and Express. Implemented
robust security measures, including encryption and authentication, to ensure the protection of sensitive data.
Successfully built and integrated RESTful APIs, enabling seamless communication between the front-end and
back-end of the application
          ...
          >
            <h3
              ...
              data-aos="fade-right"
            >
              Student [BTech. (Infromation Technology)]
            </h3>
            <h4
              className="vertical-timeline-element-subtitle"
              data-aos="fade-right"
            ...
            <p data-aos="fade-right">
            I will complete my graduation in BTech (Information Technology) in 2024
            </p>
          </VerticalTimelineElement>
          <VerticalTimelineElement
            className="vertical-timeline-element--work"
          ...
          >
            ...
            <h4
              ...
              data-aos="fade-right"
            >
              Jay Bajarang Inter College, Tarapur,Chandauli
            </h4>
            <p data-aos="fade-right">
              Studied 12th Science and Passed with 74.6 Percentage.
            </p>
          </VerticalTimelineElement>
